  ...
  useEffect(() => {
    if (from === "E-322") {
      ...
      if (activePump.includes("H-1")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p97/2", "ЗМ-8", "p98", "v140", "v140/2", "i50", "p120", "p120/2", "v170", "p119", "v204", "i76", "p96", "v205", "p146", "v206", "p154", "74", "p155", "v237", "i91", "v238", "i100", "v259", "i101", "v260", "v239", "i92", "v240", "3", "v241", "v242", "i93", "i94", "v243", "p228"];
      }

      if (activePump.includes("H-2")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p97/2", "ЗМ-8", "p98", "v140", "v140/2", "i50", "p120", "p120/2", "v170", "p119", "v204", "i76", "p96", "v205", "p146", "p147", "73", "p148", "p149", "27", "p150", "v360", "i161", "v361", "i162", "v362", "i163", "v363", "i164", "v364", "i165", "v365", "p183", "19", "p182", "v256", "38", "v257", "i98", "i99", "v258", "p229"];
      }

      if (activePump.includes("H-3")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p97/2", "ЗМ-8", "p98", "v140", "v140/2", "i50", "p120", "p120/2", "v170", "p119", "v204", "i76", "p96", "v205", "p146", "p147", "73", "p148", "p149", "27", "p150", "v360", "i161", "v361", "i162", "v362", "i163", "v363", "i164", "v364", "i165", "v365", "p184", "20", "p185", "v293", "36", "v294", "i125", "i126", "i127", "v295", "i128", "v296", "p230"];
      }

      if (activePump.includes("H-4")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p97/2", "ЗМ-8", "p98", "v140", "v140/2", "i50", "p120", "p120/2", "v170", "p119", "v204", "i76", "p96", "v205", "p146", "p147", "73", "p148", "p149", "27", "p150", "v360", "i161", "v361", "i162", "v362", "i163", "v363", "i164", "v364", "i165", "v365", "p184", "20", "p185", "p186", "v307", "v308", "29", "v309", "p206", "v310", "i132", "i133", "v311", "p231"];
      }

      if (activePump.includes("Н-1")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p99", "ЗМ-9", "p100", "v139", "v141", "v196", "i70", "v197", "i71", "v198", "p256", "v385", "ЗМ-11", "i174", "p283", "p284", "vf1", "i175", "Ф1", "p295"];
      }

      if (activePump.includes("Н-2")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p99", "ЗМ-9", "p100", "v139", "v141", "v196", "i70", "v197", "i71", "v198", "p256", "p257", "v392", "i182", "ЗМ-17", "p299", "p300", "vf2", "Ф2", "i182/2", "p301"];
      }

      if (activePump.includes("Н-3")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p99", "ЗМ-9", "p100", "v139", "v141", "v196", "i70", "v197", "i71", "v198", "p256", "p257", "p258", "v399", "i189", "ЗМ-23", "p307", "p308", "vf3", "i193", "Ф3", "p309"];
      }

      if (activePump.includes("Н-4")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p99", "ЗМ-9", "p100", "v139", "v141", "v196", "i70", "v197", "i71", "v198", "p256", "p257", "p258", "p259", "v406", "i197", "i201", "ЗМ-29", "p313", "p314", "vf4", "Ф4", "p316"];
      }

      if (activePump.includes("Н-5")) {
        // prettier-ignore
        newElements = [...newElements, "p96", "322Б", "p97", "p99", "ЗМ-9", "p100", "v139", "v141", "v196", "i70", "v197", "i71", "v198", "p256", "p257", "p258", "p259", "p260", "v413", "i205", "i209", "ЗМ-35", "p321", "p322", "vf5", "Ф5", "p324"];
      }
