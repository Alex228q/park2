...
import {
  ...
  FROM_324_TO_35_H3,
  FROM_324_TO_35_H4,
  SWAP_FROM_324_TO_322_115B,
  SWAP_FROM_324_TO_325_35B1,
  SWAP_FROM_324_TO_325_35B4,
...
import {
  ...
  FROM_328_TO_35_H3,
  FROM_328_TO_35_H4,
  SWAP_FROM_328_TO_329_35B1,
  SWAP_FROM_328_TO_329_35B2,
...
function App() {
  ...
  useEffect(() => {
    ...
    if (
      from === "E-324" &&
      (to === "E-322" || to === "E-325" || to === "E-326") &&
      lineAorB === "Б" &&
      activePumpStation === "910-115"
    ) {
      let newElements = [];
      if (activePump.includes("Н-3")) {
        newElements = [...newElements, ...SWAP_FROM_324_TO_322_115B];
      }
      const uniqueElements = [...new Set(newElements)];
      addActiveElement(uniqueElements);
    }
    ...
    if (
      ...
      let newElements = [];
      if (activePump.includes("H-1")) {
        newElements = [...newElements, ...SWAP_FROM_324_TO_325_35B1];
      }
      if (activePump.includes("H-4")) {
        newElements = [...newElements, ...SWAP_FROM_324_TO_325_35B4];
      }
      const uniqueElements = [...new Set(newElements)];
      addActiveElement(uniqueElements);
    }
    ...
    if (
      ...
      let newElements = [];
      if (activePump.includes("Н-3")) {
        newElements = [...newElements, ...SWAP_FROM_325_TO_322_115B];
      }
      const uniqueElements = [...new Set(newElements)];
      addActiveElement(uniqueElements);
    }
    ...
    if (
      ...
      let newElements = [];
      if (activePump.includes("H-1"))
        newElements = [...newElements, ...SWAP_FROM_328_TO_329_35B1];
      if (activePump.includes("H-2"))
        newElements = [...newElements, ...SWAP_FROM_328_TO_329_35B2];
      const uniqueElements = [...new Set(newElements)];
      addActiveElement(uniqueElements);
    }
    ...
    if (
      ...
      let newElements = [];
      if (activePump.includes("Н-3")) {
        newElements = [...newElements, ...SWAP_FROM_333_TO_322_115_H3A];
      }
      const uniqueElements = [...new Set(newElements)];
      addActiveElement(uniqueElements);
    }
