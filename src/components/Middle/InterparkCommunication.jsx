...
const InterparkCommunication = () => {
  return (
    <div>
      ...
      <Pipe isHorizontal top={1108} left={2446} length={666} title="p124" />
      <Pipe isHorizontal top={1177} left={1788} length={150} title="p125" />
      <Valve isUp top={1167} left={1938} title="ЗМ-46" />
      <Pipe isHorizontal top={1177} left={1957} length={92} title="p125" />
      <Pipe isHorizontal top={1177} left={2049} length={404} title="p127" />
      ...
      <Pipe isHorizontal top={1252} left={3181} length={57} title="p131" />
      <Pipe isHorizontal top={1269} left={1730} length={1202} title="p133" />
      <Pipe isHorizontal top={1298} left={1788} length={161} title="p134" />
      <Pipe isHorizontal top={1298} left={1949} length={177} title="p135" />
      <Pipe isHorizontal top={1298} left={2216} length={912} title="p136" />
      <Valve isUp top={1288} left={3128} title="83" />
      ...
      <Pipe isHorizontal top={1298} left={3224} length={14} title="p138" />
      ...
      <Pipe isHorizontal top={1327} left={3261} length={25} title="p141" />
      ...
      <Pipe isHorizontal top={1407} left={1484} length={635} title="p147" />
      <Pipe isHorizontal top={1407} left={2119} length={697} title="p149" />
      <Valve isUp top={1397} left={2816} title="27" />
      <Pipe isHorizontal top={1407} left={2835} length={40} title="p149" />
      ...
      <Pipe isHorizontal top={1407} left={2984} length={128} title="p153" />
      <Pipe isHorizontal top={1448} left={1413} length={52} title="p155" />
      ...
      <Pipe isHorizontal top={1569} left={3371} length={104} title="p161" />
      <Pipe isHorizontal top={1569} left={3475} length={115} title="p162" />
      <Pipe isHorizontal top={1569} left={3590} length={150} title="p163" />
      <Pipe isHorizontal top={1569} left={3740} length={138} title="p164" />
      <Pipe isHorizontal top={1569} left={3878} length={184} title="p165" />
      <Pipe isHorizontal top={1569} left={4062} length={46} title="p166" />
      <Pipe isHorizontal top={1488} left={3428} length={47} title="p167" />
      <Pipe isHorizontal top={1592} left={1027} length={196} title="p168" />
      ...
      <Pipe isHorizontal top={1812} left={2546} length={12} title="p274" />
      ...
      <Intersection top={1052} left={1122} title="i40" />
      <Pipe top={1066} left={1126} length={26} title="v126" />
      <Pipe top={669} left={1159} length={58} title="v179" />

      <Intersection top={728} left={1155} title="i56" />
      <Pipe top={742} left={1159} length={50} title="v180" />

      <Intersection top={792} left={1155} title="i57" />
      <Pipe top={806} left={1159} length={244} title="v181" />

      <Intersection top={1052} left={1155} title="i58" />
      <Pipe top={1066} left={1159} length={15} title="v182" />

      <Intersection top={1081} left={1155} title="i59" />
      <Pipe top={1095} left={1159} length={436} title="v183" />

      <Intersection top={1531} left={1155} title="i60" />
      <Pipe top={1545} left={1159} length={42} title="v184" />

      <Intersection top={1588} left={1155} title="i61" />
      <Pipe top={1602} left={1159} length={55} title="v185" />

      <Intersection top={1052} left={1173} title="i62" />
      <Pipe top={806} left={1177} length={244} title="v186" />

      <Intersection top={1081} left={1173} title="i63" />
      <Pipe top={1066} left={1177} length={15} title="v187" />

      <Intersection top={1531} left={1173} title="i64" />
      <Pipe top={1095} left={1177} length={436} title="v188" />

      <Intersection top={1588} left={1173} title="i65" />
      <Pipe top={1545} left={1177} length={42} title="v189" />
      ...
      <Intersection top={1081} left={1212} title="i68" />
      <Pipe top={1095} left={1216} length={274} title="v193" />
      <Pipe top={1362} left={1216} length={169} title="v194" />
      <Intersection top={1531} left={1212} title="i69" />
      <Pipe top={1545} left={1216} length={54} title="v195" />
      <Pipe top={1056} left={1038} length={475} title="v196" />
      <Intersection top={1531} left={1034} title="i70" />
      <Pipe top={1546} left={1038} length={41} title="v196" />
      <Intersection top={1588} left={1034} title="i70" />
      <Pipe top={1602} left={1038} length={141} title="v196" />
      ...
      <Pipe top={1372} left={1360} length={42} title="v204" />
      <Pipe top={1407} left={1413} length={48} title="v206" />
      <Pipe top={1108} left={3105} length={151} title="v222" />
      <Pipe top={1252} left={3105} length={43} title="v223" />
      <Intersection top={1294} left={3101} title="i83" />
      <Pipe top={1308} left={3105} length={106} title="v223" />
      <Pipe top={1407} left={3105} length={125} title="v312" />
      <Intersection top={1531} left={3101} title="i84" />
      <Pipe top={1085} left={3235} length={174} title="v159" />
      <Pipe top={1252} left={3235} length={53} title="v227" />
      <Pipe top={1298} left={3176} length={36} title="v228" />
      <Pipe top={1327} left={3176} length={205} title="v229" />
      <Intersection top={1531} left={3172} title="i85" />
      <Pipe top={1004} left={3285} length={48} title="v230" />
      <Intersection top={1052} left={3281} title="i86" />
      <Pipe top={1066} left={3285} length={268} title="v230" />
      <Pipe top={214} left={2834} length={14} title="v232" />
      <Intersection top={227} left={2830} title="i87" />
      <Pipe top={241} left={2834} length={19} title="v233" />

      <Intersection top={261} left={2830} title="i88" />
      <Pipe top={275} left={2834} length={66} title="v234" />
      <Intersection top={342} left={2830} title="i89" />
      ...
      <Pipe top={1660} left={2216} length={26} title="v376" />
